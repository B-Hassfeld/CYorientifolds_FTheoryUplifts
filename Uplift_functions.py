...
# def toric_orbifold_OLD(vc_triangulation,q,denominator=2,resolve_A1_singularities=False):
...
# def O3O7_line_bundle_OLD(vc_triangulation,q,rescalings,resolve_A1_singularities=False):
